...
export default class Quake {
  ...
  async getEarthQuakesByRadius(position, radius = 100) {
    ...
    const myParam = urlParams.get('radius');
    this._quakes = getJSON(`${this.baseUrl}&latitude=${position.lat}&longitude=${position.lon}&maxradiuskm=${myParam ? parseInt(myParam) : radius}`);
